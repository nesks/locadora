 ...
 * @author ind
 */
public class PainelBuscaGenero extends javax.swing.JFrame {

    /**
     * Creates new form PainelBuscaGenero
     */
    public PainelBuscaGenero() {
        initComponents();
    }
    
    public void montarPainel(String nome, String genero){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PainelBuscaGenero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PainelBuscaGenero().setVisible(true);
            }
        });
    }
